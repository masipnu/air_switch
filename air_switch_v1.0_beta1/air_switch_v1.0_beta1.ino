...
void loop() 
{
  ...
  client.println("<html>");
  client.println("<head><title>Air Switch v1.0</title></head>");
  ...
  client.println("<p align='center'><b>Status : ");
  if(value == HIGH) 
  {
    client.print("OFF");
  } 
  ...
  client.println("<button><a href=\"/pin_relay=OFF\">OFF</a></button>");
  client.println("<br><br>");
  client.println("<button><a href=\"/pin_relay=ON\">ON</a></button>");
  client.println("</div>");
  client.println("</html>");
